...
namespace CRM_for_English_School.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public IndexModel(
            ...
            //EnglishSchoolContext englishSchoolContext
            )
        {
        ...
        private async Task LoadAsync(IdentityUser user)
        {
            ...
            //if(user.Id == teacherRole.Id)
              //  Teacher = _englishSchoolContext.Teachers.FirstOrDefault(t => t.UserId.ToString() == user.Id);
